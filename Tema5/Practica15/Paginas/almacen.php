...
<body style="background-color: #fadcdc;">
    ...
    <header class="p-3 mb-3 border-bottom">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <li><a href="../verCodigo.php?fichero=../almacen.php" class="nav-link px-2 link-light">Ver código</a></li>
            ...
            <tbody>
                ...
                foreach ($repo as $valor) {
                    echo "<tr>";
                        ...
                        echo "<td>";
                        if (esAdmin()) {
                            echo '<a class="btn btn-danger m-2" href="./operar.php?op=mod&id='.$valor['idAlbaran'].'" role="button">Modificar registro</a>';
